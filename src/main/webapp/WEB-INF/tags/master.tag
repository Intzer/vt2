...
<header>
    ...
    <div class="container bg-success">
        <div class="row pb-3">
            ...
            <div class="col-6">
                <div class="h-100" style="display: flex; align-items: center; justify-content: end;">
                    <div class="mr-3">
            ...
            <div class="col-6">
                <div class="mt-3">
                    <a class="btn btn-light" href="?sessionLocale=en"><fmt:message key="label.lang.en" /></a>
                    <a class="btn btn-light" href="?sessionLocale=ru"><fmt:message key="label.lang.ru" /></a>

                    <c:choose>
                        <c:when test="${not empty sessionScope.login}">
                            <form class="d-inline-block" action="<c:url value="/"/>" method="get">
                    ...
                    <c:if test="${role.equals('Admin')}">
                        <form class="d-inline-block" action="<c:url value="/"/>">
